...
#if BOOST_VERSION < 103400
				: portable_iprimitive(is, flags & no_codecvt)
#else
...
#if BOOST_VERSION < 103500
#define BOOST_ARCHIVE_CUSTOM_IARCHIVE_TYPES boost::archive::portable_iarchive
#else
...
#if BOOST_VERSION < 104000
	template class detail::archive_pointer_iserializer<portable_iarchive>;
#else
